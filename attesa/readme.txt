...
== Changelog ==
= Version 1.5.9.2 =
* Optimizing javascript code to improve performance
* Minor bug fixes
...
* Improved compatibility with WooCommerce 9.4.X
* Updated WooCommerce templates
...
* Fixed a problem with featured image in a single post when the page is without sidebar
* Minor bug fixes

= Version 1.5.5 =
* Fixed a bug with the mobile menu
* Improved WooCommerce CSS

= Version 1.5.4 =
* Update WooCommerce template
* Added compatibility with WordPress 6.3 (beta)
...
* Fixed a bug with WooCommerce ajax add to cart
...
= Version 1.4.9 =
* WooCommerce: added an option to activate the AJAX add to cart on product pages
...
= Version 1.4.6 =
* Fixed logo on scroll on FireFox browser
* Added compatibility with WordPress 5.9
* Minor bug fixes

= Version 1.4.5 =
* Fixed a bug that did not show style for comments if they were closed
* Fixed a visual bug with the main logo on Safari for iOS browser
...
= Version 1.4.0 =
* Removed vendor prefixes from CSS files
* Minor bug fixes

= Version 1.3.9 =
* Fixed a bug with input border radius

= Version 1.3.8 =
* Reduced the size of the style.css file
* Improved CLS core web vitals

= Version 1.3.7 =
* Fixed custom CSS with EDD plugin
* Reduced the size of the style.css file

= Version 1.3.6 =
* Updated WooCommerce template
* Improved the generation of custom css
* Fixed some CSS bugs
