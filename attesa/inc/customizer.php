...
function attesa_customize_register( $wp_customize ) {
	...
	*/
    ...
    /* Disable Google Fonts */
	$wp_customize->add_setting('attesa_theme_options[_google_fonts_locally]', array(
        'default'    => '',
        'type'       => 'option',
        'capability' => 'edit_theme_options',
		'sanitize_callback' => 'attesa_sanitize_checkbox'
    ) );
	$wp_customize->add_control('attesa_theme_options[_google_fonts_locally]', array(
        'label'      => __( 'Host Google Fonts locally', 'attesa' ),
        'section'    => 'section_attesa_theme_options_typography',
        'settings'   => 'attesa_theme_options[_google_fonts_locally]',
        'type'       => 'checkbox',
        'active_callback' => 'attesa_is_googlefont_active',
		'priority' => 4,
    ) );
	...
	*/
	...
	if (function_exists( 'is_woocommerce' )) {
		...
		*/
		...
		$wp_customize->add_setting('attesa_theme_options[_woocommerce_ajax_add_to_cart]', array(
			'default'    => '',
			'type'       => 'option',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'attesa_sanitize_checkbox'
		) );
		$wp_customize->add_control('attesa_theme_options[_woocommerce_ajax_add_to_cart]', array(
			'label'      => __( 'Enable AJAX add to cart button on product pages', 'attesa' ),
			'section'    => 'section_attesa_theme_options_woocommerce',
			'settings'   => 'attesa_theme_options[_woocommerce_ajax_add_to_cart]',
			'type'       => 'checkbox',
			'active_callback' => 'attesa_woocommerce_ajax_add_to_cart_active',
			'priority' => 4,
		) );
...
function attesa_woocommerce_ajax_add_to_cart_active() {
