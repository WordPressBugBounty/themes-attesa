...
<div id="comments" class="comments-area">
	...
	<?php comment_form( array(
		...
		'logged_in_as' => '<p class="logged-in-as">' . sprintf( __( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>'  , 'attesa' ), esc_url(admin_url( 'profile.php' )), esc_html($user_identity), wp_logout_url( apply_filters( 'attesa_logout_the_permalink', esc_url( get_permalink( ) ) ) ) ) . '</p>',
