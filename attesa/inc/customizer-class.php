				...
				<label>
					...
					<ul class="attesa-icon-list clearfix">
						<div class="attesa-icon-list-search">
							<input class="attesaInputFilter" type="text" placeholder="<?php esc_attr_e('Filter icons...', 'attesa'); ?>">
						</div>
						<?php
	...
	class Attesa_Choose_Show extends WP_Customize_Control {
		public function render_content(){
			...
			?>
					...
					$checkExcludedType = array('toShowShare', 'toShowFooterCallout', 'toShowCategories', 'toShowToc');
