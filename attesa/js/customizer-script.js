(function($) {
	...
	$(document).ready(function() {
		...
		$( 'ul.toShowClassic li.attesaToShow input[type="checkbox"], ul.toShowPush li.attesaToShow input[type="checkbox"], ul.toShowFooter li.attesaToShow input[type="checkbox"], ul.toShowShare li.attesaToShow input[type="checkbox"], ul.toShowFooterCallout li.attesaToShow input[type="checkbox"], ul.toShowContact li.attesaToShow input[type="checkbox"], ul.toShowCategories li.attesaToShow input[type="checkbox"], ul.toShowToc li.attesaToShow input[type="checkbox"]' ).on( 'change', function() {
